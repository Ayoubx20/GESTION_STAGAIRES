...
const Timesheet = () => {
  ...
  periodDays.forEach((date) => {
    ...
    daysRender.push(
      <div key={dateKey} className={`p-4 rounded-xl border ${numHours > 0 ? 'bg-green-50/60 border-green-200 dark:bg-green-900/20 dark:border-green-800' : 'bg-white border-gray-100 dark:bg-gray-800 dark:border-gray-700'} shadow-sm transition-all hover:shadow-md`}>
